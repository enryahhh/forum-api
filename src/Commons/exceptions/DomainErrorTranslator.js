...
DomainErrorTranslator._directories = {
  ...
  'NEW_THREAD.NOT_DOING_AUTHENTICATION' : new AuthenticationError('tidak dapat menambah thread karena belum login'),
  'Missing authentication' : new AuthenticationError('tidak dapat menambah thread karena belum login'),
